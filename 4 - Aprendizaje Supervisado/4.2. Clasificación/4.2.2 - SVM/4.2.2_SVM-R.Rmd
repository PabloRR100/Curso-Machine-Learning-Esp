---
title: "SVM (Support Vector Machines) (R)"
output: pdf_document
---
...
library(caTools)
library(ggplot2)
library(e1071)         # Nos va a permitir general el modelo SVM 
...
clasificador <- svm(formula = Compra ~ .,
                    data = train,
...
y_pred = predict(clasificador, newdata = test[-3])
```
