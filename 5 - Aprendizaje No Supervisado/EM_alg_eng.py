...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  4 11:52:34 2018
...
'''
Vamos a probar este con mis datos
'''
datos = pd.read_csv('./2d_data_clustering.csv') 
datos.columns = ['x', 'y']
columna_cluster = np.random.randint(low=1, high=3, size=len(datos.x))
datos['label'] = columna_cluster
